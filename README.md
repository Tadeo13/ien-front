...
> ⚠️ **Este repositorio es solo el frontend** (la app vive en la raíz). El backend (API Express/MongoDB, seed y cron jobs) está en un repositorio separado: [`alex43x/ien-back`](https://github.com/alex43x/ien-back).
